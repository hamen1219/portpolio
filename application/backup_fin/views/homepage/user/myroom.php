...
<section>
		...
		<?php 
			...
			$geocode = file_get_contents('http://maps.google.com/maps/api/geocode/json?address='.$address.'&sensor=false&language=ko&key=1014941641350');
			...
			<div>
				<div class = "graph_wrap">
					<div class = "graph">
						...
						<div class = "graph_per">
							<p><?=$us2['total_b']?>개의 게시물 중</p>
							<h3><?=$us2['total_my_b']?>개</h3>
						</div>
					</div>
					<p>게시물작성</p>
				</div>
				<div class = "graph_wrap">
					<div class = "graph">
						...
						<div class = "graph_per">
							<p><?=$us2['total_r']?>개의 댓글 중</p>
							<h3><?=$us2['total_my_r']?>개</h3>
						</div>
					</div>
					<p>댓글작성</p>
				</div>
				<div class = "graph_wrap">
					<div class = "graph">
						...
						<div class = "graph_per">
							<p><?=$us2['total_my_b']?>개의 게시물 중</p>
							<h3><?=$us2['total_good']?>개</h3>
						</div>
					</div>
					<p>게시물 좋아요</p>
				</div>				
			...
			<div>
				<div class = "graph_wrap">
					<div class = "graph">
						...
						<div class = "graph_per">
							<p><?=$us2['total_my_r']?>개의 댓글 중</p>
							<h3><?=$us2['total_good_r']?>개</h3>
						</div>
					</div>
					<p>댓글 좋아요</p>
				</div>	
